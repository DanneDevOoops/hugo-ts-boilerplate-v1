...
**New?** Start here:
- [`STATE_MANAGEMENT_SETUP.md`](../content/guidelines/STATE_MANAGEMENT_SETUP.md) - Overview & quick start
- [`docs/guidelines/ARCHITECTURE_OVERVIEW.md`](../content/guidelines/ARCHITECTURE_OVERVIEW.md) - Visual guide

**Want to implement?**
- [`docs/guidelines/STATE_MANAGEMENT_IMPLEMENTATION.md`](../content/guidelines/STATE_MANAGEMENT_IMPLEMENTATION.md) - Step-by-step guide
- [`assets/ts/services/user.service.ts`](../assets/ts/services/user.service.ts) - Example code

**Need help?**
- [`docs/guidelines/INDEX.md`](../content/guidelines/INDEX.md) - Documentation index
- [`docs/guidelines/STATE_MANAGEMENT_QUICK_REFERENCE.md`](../content/guidelines/STATE_MANAGEMENT_QUICK_REFERENCE.md) - Quick lookup

**Building a backend?**
- [`docs/guidelines/BACKEND_API_SETUP.md`](../content/guidelines/BACKEND_API_SETUP.md) - Backend guide
- [`docs/guidelines/ENVIRONMENT_CONFIGURATION.md`](../content/guidelines/ENVIRONMENT_CONFIGURATION.md) - Configuration
...
### HTMX
```html
<button hx-post="/users/create" data-invalidate="user:list:*">
  Create User
</button>
```
...
1. **Read** [`STATE_MANAGEMENT_SETUP.md`](../content/guidelines/STATE_MANAGEMENT_SETUP.md)
2. **Understand** [`docs/guidelines/ARCHITECTURE_OVERVIEW.md`](../content/guidelines/ARCHITECTURE_OVERVIEW.md)
3. **Implement** [`docs/guidelines/STATE_MANAGEMENT_IMPLEMENTATION.md`](../content/guidelines/STATE_MANAGEMENT_IMPLEMENTATION.md)
4. **Copy** [`assets/ts/services/user.service.ts`](../assets/ts/services/user.service.ts)
5. **Build** [`docs/guidelines/BACKEND_API_SETUP.md`](../content/guidelines/BACKEND_API_SETUP.md)
...
useStore((state) => { /* react to changes */ });
```
...
See [`docs/guidelines/ENVIRONMENT_CONFIGURATION.md`](../content/guidelines/ENVIRONMENT_CONFIGURATION.md) for full details.
...
- **Quick Start**: [`STATE_MANAGEMENT_SETUP.md`](../content/guidelines/STATE_MANAGEMENT_SETUP.md)
- **Documentation Index**: [`docs/guidelines/INDEX.md`](../content/guidelines/INDEX.md)
...
Refer to:
- **"Where do I start?"** → [`STATE_MANAGEMENT_SETUP.md`](../content/guidelines/STATE_MANAGEMENT_SETUP.md)
- **"How does it work?"** → [`docs/guidelines/ARCHITECTURE_OVERVIEW.md`](../content/guidelines/ARCHITECTURE_OVERVIEW.md)
- **"How do I use it?"** → [`docs/guidelines/STATE_MANAGEMENT_IMPLEMENTATION.md`](../content/guidelines/STATE_MANAGEMENT_IMPLEMENTATION.md)
- **"I need help!"** → [`docs/guidelines/INDEX.md`](../content/guidelines/INDEX.md)
